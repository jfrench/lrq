...
<img src="https://raw.githubusercontent.com/jfrench/LinearRegression/0ece3fee82ea5e6188728023edf1dfa8318e4d48/images/qr-random-vectors.svg" width="100">
</a>
...
Using the definitions and results for random vectors, we want to answer **Q7** of the hydration example in @sec-continuous-bivariate-distribution-example. Summarizing only the essential details, we have a $2\times 1$ random vector $\mathbf{z}=[X, Y]$ with mean $E(\mathbf{z})=[2/5, 4/5]$ and covariance matrix
$$
\mathrm{var}(\mathbf{z})=
\begin{bmatrix}
14/225 & 1/75 \\
